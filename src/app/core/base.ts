 ...
 * **Class**
 *
 * When used in factories as `C extends CoreBaseClassNonRecursive`, generic `C` must be extending {@link CoreBaseClassNonRecursive}, even though `C` is only vaguely constrained by {@link CoreBaseClassNonRecursive}, the core base class information should be inserted by casting, when necessary.
 * Core universe object classes should be extending this, as they should be able to have universe access.
 *
 * **Instance**
 *
 ...
 * Thus, {@link CoreBaseNonRecursiveInstance}'s universe is {@link CoreBaseNonRecursiveUniverseInstance}, so that only recursion that happens, is the primary recursion.
 *
